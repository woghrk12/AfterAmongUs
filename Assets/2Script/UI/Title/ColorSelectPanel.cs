...
public class ColorSelectPanel : MonoBehaviour
{
    ...
    [SerializeField] private List<Button> colorSelectButton = new List<Button>();

    private void OnEnable()
    {
        var t_color = (int)GameManager.playerColor;
        colorSelectButton[t_color].interactable = false;
