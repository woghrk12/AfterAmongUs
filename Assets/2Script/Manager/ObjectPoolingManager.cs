...
public class ObjectPoolingManager : MonoBehaviour
{
    ...
    public static GameObject SpawnObject(string p_tag)
        => instance.SpawnFromPool(p_tag, Vector3.zero, Quaternion.identity);
    public static GameObject SpawnObject(string p_tag, Vector3 p_position)
        => instance.SpawnFromPool(p_tag, p_position, Quaternion.identity);
