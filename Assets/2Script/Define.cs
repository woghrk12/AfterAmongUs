...
public enum ELayer { DEFAULT, TRANSPARENTFX, IGNORERAYCAST, MAP, WATER, UI, MOVEMENTCOLLIDER, HITBOX, HITBOXTRIGGER, ENEMYHITBOX, REGION, CAMERACOLLIDER, ENEMYMOVEMENTCOLLIDER, END }
